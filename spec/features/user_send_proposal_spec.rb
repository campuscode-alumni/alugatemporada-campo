...
feature 'user send a proposal' do
  scenario 'successfuly' do
    ...
    expect(page).to have_css('p', text: 'Felix')
    expect(page).to have_css('p', text: 'felix@email.com')
    expect(page).to have_css('p', text: '121212-13131')
    expect(page).to have_css('p', text: 'Despedida de solteiro')
    expect(page).to have_css('p', text: 12)
    expect(page).to have_css('p', text: 'estadia de 21/11/2018 até 28/11/2018')
    expect(page).to have_css('p', text: 'Vou levar meu pet')
    expect(page).to have_css('p', text: 'Sou fumante')
